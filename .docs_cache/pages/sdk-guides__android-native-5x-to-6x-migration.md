...
- **Phase**: Allows to specify the pricing of the offer. You can add up to 2 âphasesâ to an offer. There are 3 types of offer:
...
- Create a subscription for each set of features you need to unlock (e.g. âProâ, âPremiumâ,â¦)
- Create a base plan for each renewal period you want to provide your users (e.g. âmonthlyâ, âyearlyâ,...)
- If you want to provide free trials or other types of offers, add an offer with your choice of eligibility criteria and the appropriate phase. For example, to add a free trial for new users, you can create an offer with eligibility criteria âNew customer acquisitionâ and a free trial phase with your desired duration.
