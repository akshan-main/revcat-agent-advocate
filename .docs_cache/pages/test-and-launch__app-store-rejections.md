---
id: "test-and-launch/app-store-rejections"
title: "Apple App Store Rejections"
description: "Your app is finally complete! ð You're tracking subscriptions in Sandbox, your Testflight users love it, you've followed our Launch Checklist, and you're finally ready to launch your app to the world."
permalink: "/docs/test-and-launch/app-store-rejections"
slug: "app-store-rejections"
version: "current"
original_source: "docs/test-and-launch/app-store-rejections.mdx"
---

Your app is finally complete! ð You're tracking subscriptions in Sandbox, your Testflight users love it, you've followed our [Launch Checklist](/test-and-launch/launch-checklist), and you're finally ready to launch your app to the world.
...
> If you're able to test purchases on your device successfully but App Review runs into issues fetching products, it's likely an issue with their environment. There isn't much you can do in these cases- some users have had to re-submit the same build up to a dozen times before being approved.

## Error during purchase

If an error occurs during the purchase process, it will be one of the errors outlined in our [Error Handling guide here](/test-and-launch/errors). Understanding what error triggered the rejection is the only way to make sure the issue gets resolved.
...
This is actually the generic error message Apple uses for all [SKErrors](https://developer.apple.com/documentation/storekit/skerror) and not an error message from RevenueCat. See our [guide on Error Handling](/test-and-launch/errors) for more info.

### STORE\_PROBLEM - "There was a problem with the App Store"
...
Double check that you're [checking the subscription status correctly](/customers/customer-info) and all of the [products are added to Entitlements](/getting-started/entitlements) as needed.
