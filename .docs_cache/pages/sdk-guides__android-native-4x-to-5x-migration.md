---
id: "sdk-guides/android-native-4x-to-5x-migration"
title: "Android Native - 4.x to 5.x Migration"
description: "View the Android SDK Reference documentation here â."
permalink: "/docs/sdk-guides/android-native-4x-to-5x-migration"
slug: "android-native-4x-to-5x-migration"
version: "current"
original_source: "docs/sdk-guides/android-native-4x-to-5x-migration.mdx"
---

:::info
View the Android SDK Reference documentation [here â](https://sdk.revenuecat.com/android/index.html).
:::

There were various updates to our API in this release, in order to best support the Amazon Store and to maintain parity with our iOS SDK, which recently [migrated from ObjC to Swift](/sdk-guides/ios-native-3x-to-4x-migration).
...
For more information about recommended identity logic following the removal of these identification methods, see [Identifying Users](/customers/user-ids).
...
- Amazon support (see [the section in our docs for more information](/platform-resources/amazon-platform-resources))
