...
**The flow:** User purchases a **Product** â Unlocks an **Entitlement** â You check the entitlement to grant access.

## 1. Choose Your Product Type

Your project comes with a **Test Store** automatically configured. This lets you create products and test purchases immediatelyâno App Store or Google Play account required.
...
2. Navigate to **Product catalog â Products**
...
[Learn more about entitlements â](/getting-started/entitlements)
...
1. Navigate to **Product catalog â Offerings**
2. Click **+ New**
3. Give it an identifier (e.g., "default")
4. Add Packagesâthese group equivalent products across platforms (e.g., monthly subscriptions from iOS and Android)

The offering marked as "default" is automatically returned as `currentOffering` in the SDK.

[Learn more about offerings â](/offerings/overview)
...
Or jump straight to the [SDK Quickstart â](/getting-started/quickstart)
